...
```
python get_compound_scores.py --input_dsv_file data/example_input.tsv --iheader --smiles_column 1 --name_column 0 --output_tsv data/example_output.tsv --batch_size 20
```
